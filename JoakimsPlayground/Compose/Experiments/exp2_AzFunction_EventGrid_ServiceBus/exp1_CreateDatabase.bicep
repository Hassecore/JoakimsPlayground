...
resource allowAzure 'Microsoft.Sql/servers/firewallRules@2023-05-01-preview' = {
    name: 'AllowAllAzureServices' // Disable for stricter security. But this is needed for Consumption Plan Azure Functions (unlesss I implement Dedicated/Premium Az Function with VNet integration)
    parent: sqlServer
  properties: {
