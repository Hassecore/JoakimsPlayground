...
var subnet3Name = 'keyVaultSubnet'
var subnet3Prefix = '10.137.4.0/22'

var caSubnetName = 'caSubnet'
var caSubnetPrefix = '10.137.8.0/22'

var azFunctionSubnetName = 'azFunctionSubnet'
var azFunctionSubnetPrefix = '10.137.12.0/24'
...
resource virtualNetwork 'Microsoft.Network/virtualNetworks@2024-05-01' = {
    ...
    properties: {
        ...
        subnets: [
            ...
            {
                name: azFunctionSubnetName
                properties: {
                    addressPrefix: azFunctionSubnetPrefix
                    // serviceEndpoints: [
                    //     {
                    //         service: 'Microsoft.KeyVault'
                    //     }
...
output kvSubnetResourceId string = virtualNetwork.properties.subnets[3].id
output caSubnetResourceId string = virtualNetwork.properties.subnets[4].id

output azFunctionSubnetResourceId string = virtualNetwork.properties.subnets[5].id